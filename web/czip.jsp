   ...
   if ((contentType.indexOf("multipart/form-data") >= 0)) {
      ...
      try{ 
         ...
         while ( i.hasNext () ) 
         {
            ...
            {
                if(ext.equals(".zip"))           //checking if extension is .jpg or .jpeg
                {
            ...
            session.setAttribute("cKey", 1);
            out.println("<ins><b>Upload Successful!</b></ins><br> Filename: "  + 
            fileName + "<br>");             //message for successful upload
            }
                else                //else  block when extension type does not match
                {
                 %>
                 <ins><b>File not Uploaded.</b></ins>> <br>  
                Unknown file format. Please upload only .zip <br>
                <br><br><a href ="czip.html"><span>
            ...
            else                            //else block if size exceed the given limit                            
            {
             %>
             <ins><b>File not Uploaded.</b></ins> <br>   
             Size Limit Exceeded. Please make sure file size is less than 20MB.<br>
                <br><br><a href ="czip.html"><span>
                <input type="button" value = "Try Again"></span></a>
